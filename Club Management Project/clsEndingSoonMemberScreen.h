...
class clsEndingSoonMemberScreen : protected clsScreen
{
private:
...
public:
    ...
    static void ShowEndingSoonMembersList()
    {

        vector <clsBankMember> vMembers = clsBankMember::GetEndingSoondMembersList();
