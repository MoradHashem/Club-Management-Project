...
public:
	...
	static string GetSystemDateTimeString()
	{
		...
		return ("Time-> " + to_string(Day) + "/" + to_string(Month) + "/"
			+ to_string(Year) + " - "
	...
	static int GetDifferentDaysBetweenDates(clsDate Date1, clsDate Date2)
	{
		return (Date2.DaysFromTheBeginingOfTheYear() - Date1.DaysFromTheBeginingOfTheYear());
	}
	...
	bool IsDate1BeforeDate2(clsDate Date1)
	{
		//note: *this sends the current object :-) 
		return  IsDate1BeforeDate2(*this, Date1);
